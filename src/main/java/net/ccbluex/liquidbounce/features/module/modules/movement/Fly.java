...
@ModuleInfo(name = "Fly", spacedName = "Fly", lsName = "Flight", spacedlsName = "Flight", description = "Allows you to fly in survival mode.", category = ModuleCategory.MOVEMENT, keyBind = Keyboard.KEY_F)
